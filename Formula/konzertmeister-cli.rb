class KonzertmeisterCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/nikbucher/konzertmeister-cli/releases/download/v#{version}/km-aarch64-apple-darwin.tar.gz"
      sha256 "d6d0c770782845696974051cb02d8f649c45aac07e560f5fbac268bb2b719fda"
    end

    on_intel do
      url "https://github.com/nikbucher/konzertmeister-cli/releases/download/v#{version}/km-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/nikbucher/konzertmeister-cli/releases/download/v#{version}/km-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "be9ead1306ca09451b0e0270e6eed93bed09b3f613c8d3d4e7b3e9ca05511202"
    end

    on_intel do
      url "https://github.com/nikbucher/konzertmeister-cli/releases/download/v#{version}/km-x86_64-unknown-linux-gnu.tar.gz"
